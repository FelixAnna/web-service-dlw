...
type ProblemService[number entity.Number] struct {
	mock.Mock
}
...
func (_m *ProblemService[number]) EXPECT() *ProblemService_Expecter {
	return &ProblemService_Expecter{mock: &_m.Mock}
}

// GenerateProblem provides a mock function with given fields: criteria
func (_m *ProblemService[number]) GenerateProblem(criteria ...interface{}) *entity.Problem[number] {
	var _ca []interface{}
	_ca = append(_ca, criteria...)
	ret := _m.Called(_ca...)

	var r0 *entity.Problem[number]
	if rf, ok := ret.Get(0).(func(...interface{}) *entity.Problem[number]); ok {
		r0 = rf(criteria...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*entity.Problem[number])
		}
	}
...
func (_c *ProblemService_GenerateProblem_Call) Return(_a0 *entity.Problem[int]) *ProblemService_GenerateProblem_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func NewProblemService(t mockConstructorTestingTNewProblemService) *ProblemService[int] {
	mock := &ProblemService[int]{}
	mock.Mock.Test(t)
